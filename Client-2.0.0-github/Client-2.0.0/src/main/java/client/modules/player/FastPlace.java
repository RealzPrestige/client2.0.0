...
public class FastPlace extends Module {
    ...
    public Setting <Integer> packets = this.register(new Setting("Packets", 1, 0, 20, v-> crazyFastExpExploit.getValue()));
    ...
    public void onUpdate(){
        ...
        if (InventoryUtil.holdingItem(ItemEndCrystal.class) && this.crystal.getValue()){
            FastPlace.mc.rightClickDelayTimer = 0;
        }
        if (this.crazyFastExpExploit.getValue()) {
