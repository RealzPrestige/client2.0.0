...
public class PopChams2 extends Module {
    public static PopChams2 INSTANCE = new PopChams2();
    ...
    public PopChams2() {
        super("PopChams2", "Op module.2", Category.VISUAL);
    }
    ...
    public void onTotemPop(EntityPlayer entityPlayer) {
                if (self.getCurrentState() || entityPlayer.getEntityId() != mc.player.getEntityId()) {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        if (player != null && PopChams.INSTANCE.isEnabled()) {
            ...
            renderEntity(player, playerModel, player.limbSwing, 0, player.ticksExisted, player.rotationYawHead, player.rotationPitch, 1);
